...
public class PmsProductAttributeCategoryController {
    ...
    public Object create(@RequestParam String name) {
        ...
        //TODO 添加商品属性分类
        productAttributeCategoryService.addCategory(name);
    ...
    public Object update(@PathVariable Long id, @RequestParam String name) {
        ...
        Map<String,Object> map = productAttributeCategoryService.updateByIdCategory(id,name);

        return new CommonResult().dataMessage(map);
    }
    ...
    public Object delete(@PathVariable Long id) {
        //TODO 删除单个商品属性分类
        boolean result=productAttributeCategoryService.deleteById(id);
        if(!result){
    ...
    public Object getList(@RequestParam(defaultValue = "5") Integer pageSize, @RequestParam(defaultValue = "1") Integer pageNum) {
        //TODO 分页获取所有商品属性分类
        Map<String,Object> pageInfo=productAttributeCategoryService.pageProduct(pageSize,pageNum);
